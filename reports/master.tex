...
%TODO write about how this can help studies and algorithm development in several cases

The reason why mapping from one domain to another within the field of deep learning trained on MRI data is due to the fact that in a lot of cases around the world accessing MRI data can be complex. 

%Brains might be differnet demographically so nice to test

%TODO Write about how it can increase demographic and more robust models by enabling to use data from all over the world KAPPA gg
