...
%TODO: Find en god måde at vise denne arkitektur
...
\begin{table}[H]\label{discriminator_layers}
	...
	\begin{tabular}{lll}\toprule
		...
		Sigmoid                       &                 & NA    \\ \bottomrule
	\end{tabular}
	\caption{The convolutions, stride and padding of each layer in the discriminators. The values used in the activation functions and instance normalization as well as when they are used in the network have also been shown.}
\end{table}
