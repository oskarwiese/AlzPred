...
The location of the samples in the mapping process is optimized using the Kullback-Liebler (KL) divergence as a cost function. The KL divergence measures the similarity of two distributions, in this case: $ P $ and $ Q $. 
\begin{equation*}\label{key}
