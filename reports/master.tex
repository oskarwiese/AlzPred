...
The MRI are three dimensional images of the subjects brain. 
The raw images stems from the original analysis 2004 etc. etc.
...
A Generative Adversarial Network (GAN) was not actually implemented in this project, but it will hopefully help to give the proper insight into the reasoning behind cycleGANs later in this section.
