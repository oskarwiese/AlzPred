...
load_checkpoint('/dtu-compute/ADNIbias/AlzPred_Oskar_Anders/git_code/AlzPred/preliminary/horse2zebra_cyclegan/models/gen_a_epoch_0_idx_0.pth.tar', G_a, opti_g, config.GEN_LEARNING_RATE)
load_checkpoint('/dtu-compute/ADNIbias/AlzPred_Oskar_Anders/git_code/AlzPred/preliminary/horse2zebra_cyclegan/models/gen_b_epoch_0_idx_0.pth.tar', G_b, opti_g, config.GEN_LEARNING_RATE)
load_checkpoint('/dtu-compute/ADNIbias/AlzPred_Oskar_Anders/git_code/AlzPred/preliminary/horse2zebra_cyclegan/models/disc_a_epoch_0_idx_0.pth.tar', D_a, opti_d, config.DISC_LEARNING_RATE)
load_checkpoint('/dtu-compute/ADNIbias/AlzPred_Oskar_Anders/git_code/AlzPred/preliminary/horse2zebra_cyclegan/models/disc_b_epoch_0_idx_0.pth.tar', D_b, opti_d, config.DISC_LEARNING_RATE)
with torch.no_grad():
