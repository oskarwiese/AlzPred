...
SUBJECT_NAMES=$(ls /dtu-compute/ADNIbias/freesurfer_ADNI1/ | grep '_S_')
...
for f in $SUBJECT_NAMES; do 
	...
	mri_vol2vol --mov /dtu-compute/ADNIbias/freesurfer_ADNI1/$f/mri/norm.mgz --targ $FREESURFER_HOME/average/mni305.cor.mgz --xfm /dtu-compute/ADNIbias/freesurfer_ADNI1/$f/mri/transforms/talairach.xfm --o /dtu-compute/ADNIbias/freesurfer_ADNI1/$f/norm_mni305.mgz
done
